...
urlpatterns = [
    ...
    path('reset_password/', auth_views.PasswordResetView.as_view(template_name='accounts/forgot-password-34.html'), 
    name = 'reset_password'),
    ...
    path('account-verify/<slug:token>', views.account_vertify, name="account-verify")
